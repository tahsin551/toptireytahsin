...
const PRODUCTS = [
  { id:'tt-tee-blk',    name:'Tread Tee — Black',               category:'Tees',        price:650,  sizes:['S','M','L','XL'],   glyph:'TREAD|TEE',      image:null, desc:'Our core heavyweight tee, 240 GSM cotton, boxy fit with a tread-stripe hem tag. The everyday base layer of the whole line.', spec:{Fabric:'240 GSM Cotton', Fit:'Boxy', Care:'Machine wash cold'} },
  { id:'tt-tee-wht',    name:'Tread Tee — Off-White',            category:'Tees',        price:650,  sizes:['S','M','L','XL'],   glyph:'TREAD|TEE',      image:null, desc:'Same heavyweight build as the black tee, in a chalky off-white that wears in, not out.', spec:{Fabric:'240 GSM Cotton', Fit:'Boxy', Care:'Machine wash cold'} },
  { id:'tt-hood-char',  name:'Grip Hoodie — Charcoal',            category:'Hoodies',     price:1450, sizes:['S','M','L','XL'],   glyph:'GRIP|HOODIE',    image:null, desc:'Brushed-fleece hoodie with a double-layer hood and kangaroo pocket. Heavy enough for Chattogram winters.', spec:{Fabric:'320 GSM Fleece', Fit:'Relaxed', Care:'Machine wash cold'} },
